...
public class AccessionJobSteps {
    ...
    public void user_selects_all_required_fields() {
        ...
        accessionJob.ownerFieldOptions.get(1).click();
  ...
  // Assert.assertEquals("Selected option is not displayed ", "George Washington", actual);
    ...
    public void user_types_in_the_Media_Type_dropdown_search_field(String string) {
    ...
    public void user_selects_an_option_from_the_Media_Type_dropdown() throws InterruptedException {
