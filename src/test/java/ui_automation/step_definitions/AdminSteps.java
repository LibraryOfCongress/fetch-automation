...
public class AdminSteps {
    ...
    public void user_verifies_Add_New_dropdown_options(io.cucumber.datatable.DataTable dataTable) throws InterruptedException {
        ...
        for (Map<String, String> map : maps) {
            ...
            Assert.assertEquals("Options name verification failed",
    ...
    public void user_verifies_fields_on_Edit_Shelf_modal(io.cucumber.datatable.DataTable dataTable) {
        List<Map<String, String>> maps = dataTable.asMaps(String.class, String.class);
        int i = 0;
        ...
        for (Map<String, String> map : maps) {
            ...
            Assert.assertEquals("Fields name verification failed",
                    expectedField, actualField);
            i++;
        }
...
//        admin.modalFieldOptions.get(0).click();
    ...
    public void user_selects_Module_from_dropdown() {
        //admin.moduleField.click();
        admin.selectModule.click();
        helper.jSClick(admin.fieldDropdwnList.get(2));
    }
